...
Usage:
    ...
    python compare_evaluations.py evaluation_results/run_*/test_metrics.json --output comparison.csv
"""
...
使用示例:
  ...
  # 对比特定runs
  python compare_evaluations.py evaluation_results/run_20260113_*/test_metrics.json
